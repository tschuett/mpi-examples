...
extern void pack_surface_simple(const double *in, double *surface_data_out[6], int N);
extern void update_local_grid_simple(double *out, const double *in, int N);
extern void copy_in_neighbors_data_simple(double *in, double *surface_data_in[6], int N);
